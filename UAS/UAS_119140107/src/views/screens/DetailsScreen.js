    ...
    <SafeAreaView style={{flex: 1, backgroundColor: COLORS.white}}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={style.detailsContainer}>
          ...
          Kursi modern yang dirancang dengan lekukan mewah dalam desain organik namun terstruktur yang menahan tubuh duduk dan memberikan perasaan relaksasi sambil menawarkan dukungan punggung yang sangat baik.
          </Text>
          <View
            style={{
              marginVertical: 20,
